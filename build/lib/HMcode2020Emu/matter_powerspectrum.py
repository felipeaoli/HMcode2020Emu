...
#params = {
#    'omega_cdm'     :  [0.315, 0.31],
#    'As'            :  [np.exp(3.07)*1.e-10, np.exp(3.1)*1.e-10],
...
#    'z'             :  [0., 0.]
#}
#emulator = Matter_powerspectrum()
#k, pk_lin_total = emulator.get_linear_pk(nonu=False, **params)
#k, pknl = emulator.get_nonlinear_pk(baryonic_boost=False, nonu=False, **params)
#sigma8, fsigma8 = emulator.get_sigma8(**params)

###
#plot linear versus non-linear: LCDM redshifts (left: full, right: ratios)
#plot baryonic feedback 
#plot with without neutrinos: linear (left) and non-linear (right)
#plot w, w0wa: nonlinear ratios with LCDM (left), fsigma8 (right)
